...
public class Lockedme_project {

	public static void main(String[] args) throws NoSuchElementException {
		System.out
				.println("::::::::::::::::::::::: Welcome to our Company \"LOCKERS PVT. LTD\" :::::::::::::::::::::: \n"
						+ "::::::::::::::::::::::: Our Project name is \"LOCKEDME.COM\" ::::::::::::::::::::::::::::: \n"
						+ "::::::::::::::::::::::: This Proj is developed by \"Kedarnath \"::::::::::::::::::::::::::");
		File dirc = new File("D:\\simplilearn stuff\\PHASE END PROJECTS\\JAVA PHASE 1 OOPS ASSIGNMENT\\PHASE 1 PROJECT\\Phase_1_Project\\files\\");
		boolean value = dirc.mkdir();
		...
		do {
			...
			case (1): {
				...
				File file = new File("D:\\simplilearn stuff\\PHASE END PROJECTS\\JAVA PHASE 1 OOPS ASSIGNMENT\\PHASE 1 PROJECT\\Phase_1_Project\\files\\");
				if (file.isDirectory()) {
			...
			case (2): {
				do {
					...
					case (1): {
						...
						File stockFile = new File("D:\\simplilearn stuff\\PHASE END PROJECTS\\JAVA PHASE 1 OOPS ASSIGNMENT\\PHASE 1 PROJECT\\Phase_1_Project\\files\\" + p1);
						if (stockFile.exists()) {
							System.out.println("\nFile Already Exists");
						} else {
							try {
					...
					case (2): {
						...
						System.out.println("\nPlease Enter the file name you wnat to delete: ");
						String p2 = inp2.nextLine();
						File file = new File("D:\\simplilearn stuff\\PHASE END PROJECTS\\JAVA PHASE 1 OOPS ASSIGNMENT\\PHASE 1 PROJECT\\Phase_1_Project\\files\\" + p2);
						if (file.exists()) {
							if (file.delete()) {
